...
def getGuess(alreadyGuessed, secretWord):
    while not gameIsOver:
        print('Guess a letter or enter "solve" if you think you can solve the puzzle')
        print('*NOTE*  If you try to solve and are wrong you lose the game')
        guess = input('Make your guess:  ')
        guess = guess.upper()
        if guess == 'SOLVE':
            guess = input('Make your guess:  ')
            if guess.upper() == secretWord:
                ...
                print('Sorry, you lose.  The answer was ' + secretWord)
                if playAgain():
                    hangmanGame()
                else:
                    print('I hope you enjoyed Monty Python Hangman.')
